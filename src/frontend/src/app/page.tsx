...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-16 pb-12">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-orange-50/60 via-amber-50/30 to-white py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-100 text-orange-800 text-xs font-semibold mb-6 shadow-sm">
            <Sparkles className="w-4 h-4 text-orange-600" />
            <span>Nền tảng ẩm thực thế hệ mới — .NET 10 & Next.js App Router</span>
          </div>
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-gray-900 tracking-tight max-w-4xl mx-auto leading-tight sm:leading-none">
            Khơi dậy đam mê nấu ăn với{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-amber-600">
              hàng nghìn công thức
            </span>{' '}
            hấp dẫn
          </h1>

          <p className="mt-6 text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Khám phá hương vị ẩm thực phong phú, công thức chi tiết từng bước, định lượng nguyên liệu chuẩn xác và thông tin dinh dưỡng minh bạch.
          </p>
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/recipes"
              className="px-8 py-3.5 rounded-xl bg-orange-600 text-white font-semibold shadow-lg shadow-orange-200 hover:bg-orange-700 hover:scale-105 transition-all flex items-center gap-2"
            >
            ...
            <Link
              href="/categories"
              className="px-8 py-3.5 rounded-xl bg-white text-gray-800 font-semibold border border-gray-200 hover:bg-gray-50 hover:border-gray-300 transition-all flex items-center gap-2"
            >
              Xem danh mục
        ...
        {categories.length === 0 ? (
          <div className="text-center py-12 bg-gray-50 rounded-2xl border border-gray-100 p-8">
            ...
            <p className="text-xs text-gray-400 mt-2">
              (Truy cập <Link href="/dashboard/categories" className="text-orange-600 underline">Quản trị danh mục</Link> để thêm danh mục mới).
            </p>
          </div>
        ) : (
