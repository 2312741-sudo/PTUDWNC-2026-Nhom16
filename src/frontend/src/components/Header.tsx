      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/" className="flex items-center gap-2 group">
            <div className="w-10 h-10 rounded-xl bg-orange-600 flex items-center justify-center text-white shadow-md shadow-orange-200 transition-transform group-hover:scale-105">
          ...
          <div className="hidden md:flex flex-1 max-w-md mx-8">
            ...
            >
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 text-sm bg-gray-50 border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-orange-500 focus:bg-white transition-all text-gray-800"
              />
            </form>
          </div>
          ...
          <div className="hidden sm:flex items-center gap-3">
            ...
            <Link
              href="/auth/register"
              className="px-4 py-2 text-sm font-medium text-white bg-orange-600 rounded-xl hover:bg-orange-700 shadow-sm shadow-orange-200 transition-all"
            >
              Đăng ký
            </Link>
          </div>
        ...
        <div className="md:hidden border-t border-gray-100 bg-white px-4 pt-3 pb-6 space-y-3">
          <form action="/search" method="GET" className="relative flex items-center mb-3">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
            />
          </form>
          ...
          <div className="pt-3 border-t border-gray-100 flex gap-2">
            <Link
              href="/auth/login"
              className="flex-1 text-center py-2 border border-gray-200 rounded-lg text-sm font-medium"
            >
              Đăng nhập
            </Link>
            <Link
              href="/auth/register"
              className="flex-1 text-center py-2 bg-orange-600 text-white rounded-lg text-sm font-medium"
            >
              Đăng ký
            </Link>
          </div>
